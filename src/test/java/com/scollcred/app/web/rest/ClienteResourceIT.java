...
class ClienteResourceIT {
    ...
    void putNewCliente() throws Exception {
        ...
        updatedCliente.nombre(UPDATED_NOMBRE).apellido(UPDATED_APELLIDO).telefono(UPDATED_TELEFONO).dni(UPDATED_DNI);
    ...
    void fullUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.nombre(UPDATED_NOMBRE).apellido(UPDATED_APELLIDO).telefono(UPDATED_TELEFONO).dni(UPDATED_DNI);
